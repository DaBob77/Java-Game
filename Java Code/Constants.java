public final class Constants {
    ...
    // Physics
    public static final int TERMINAL_VELOCITY = 42; // Max fall speed
    ...
    public static final int PORTAL_X_OFFSET = 0;
    public static final int PORTAL_Y_OFFSET = 10;
    public static final int PORTAL_EXIT_OFFSET = 30; // Distance player appears from portal after teleporting
    public static final double PORTAL_VELOCITY_DAMPER = 0.8;
 

    // Portal dimensions
    public static final int PORTAL_WIDTH = 55;
    public static final int PORTAL_HEIGHT = 70;
